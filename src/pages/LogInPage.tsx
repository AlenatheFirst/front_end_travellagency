...
import ContactUsPageGraphic from "@/assets/login.png";
...
const LogInPage = ({ setSelectedPage }: Props) =>{
   ...
   <>
    ...
    <section id="contactus" className="mx-auto w-5/6 pt-24 pb-32">
      ...
      >
        ...
        >
          <HText>
            <span className="text-primary-500">LOG IN NOW</span> AND CONTINUE EXPLORING THE WORLD
          </HText>
        </motion.div>
